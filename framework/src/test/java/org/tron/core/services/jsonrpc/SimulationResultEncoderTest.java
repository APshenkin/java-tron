...
public class SimulationResultEncoderTest {
   ...
   * the literal: editing the production literal in {@link SimulationResultEncoder} without
   * also updating the literal here will diverge and fail CI.
   */
  @Test
  public void trc10TransferTopicHex_isStable() {
    ...
    assertEquals(expected, SimulationResultEncoder.TRC10_TRANSFER_TOPIC_HEX);
  }
}
